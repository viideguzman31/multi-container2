docker build -t viideguzman/multi-client:latest -t viideguzman/multi-client:$GIT_SHA -f ./client/Dockerfile ./client
docker build -t viideguzman/multi-server:latest -t viideguzman/multi-server:$GIT_SHA -f ./server/Dockerfile ./server
docker build -t viideguzman/multi-worker:latest -t viideguzman/multi-worker:$GIT_SHA -f ./worker/Dockerfile ./worker
